package com.asiainfo.reflectasm;
...
public abstract class FieldAccess {
    static public FieldAccess get(Class<?> type) {
        ...
        if (accessClass == null) {
            ...
            MethodVisitor mv;
            cw.visit(V1_1, ACC_PUBLIC, accessClassNameInternal, null, "com/esotericsoftware/reflectasm/FieldAccess",
                    null);
            {
                mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
                mv.visitCode();
                mv.visitVarInsn(ALOAD, 0);
                mv.visitMethodInsn(INVOKESPECIAL, "com/asiainfo/reflectasm/FieldAccess", "<init>", "()V");
                mv.visitInsn(RETURN);
                mv.visitMaxs(0, 0);
                mv.visitEnd();
            }
